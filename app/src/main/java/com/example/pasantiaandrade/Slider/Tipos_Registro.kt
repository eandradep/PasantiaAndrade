...
import com.example.pasantiaandrade.interfaz_master
import com.sdsmdg.tastytoast.TastyToast
import kotlinx.android.synthetic.main.slide_tipos_registro.view.*

class Tipos_Registro(private var context: Context) : PagerAdapter() {
            ...
            when (position) {
                ...
                1 -> {
                    ...
                    if (usuario.TM_Nombre.isNullOrEmpty() or usuario.TM_Nombre.isNullOrBlank())
                        ...
                        val intent = Intent(context, interfaz_master::class.java)
